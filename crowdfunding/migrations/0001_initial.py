...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Products',
            fields=[
                ('postId', models.PositiveIntegerField(primary_key=True, serialize=False, verbose_name='게시글 ID')),
                ...
                ('targetAmount', models.PositiveIntegerField(editable=False, null=True, verbose_name='목표 금액')),
                ('startDate', models.DateTimeField(auto_now_add=True, verbose_name='펀딩 시작일')),
                ('endDate', models.DateField(default=datetime.date(2022, 5, 4), verbose_name='펀딩 종료일')),
